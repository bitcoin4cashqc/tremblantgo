							...
							<div class="Reveal-cats-box">
								<article class="Reveal-arbnb-box style-1">
									...
									<div class="Reveal-Reveal-arbnb-box-image">
										<figure>
											<a href="stays.html">
												<img src="https://via.placeholder.com/650x440" class="img-responsive Reveal-listing-box-img" alt="">
											</a>
										</figure>
									</div>
							...
							<div class="Reveal-cats-box">
								<article class="Reveal-arbnb-box style-1">
									...
									<div class="Reveal-Reveal-arbnb-box-image">
										<figure>
											<a href="hotels.html">
												<img src="https://via.placeholder.com/1200x800" class="img-responsive Reveal-listing-box-img" alt="">
											</a>
										</figure>
									</div>
							...
							<div class="Reveal-grid-item classical-list">
								<div class="image">
									<a href="listing-detail.html" class="Reveal-featured-listing-thumb">
										<img src="https://via.placeholder.com/1200x800" alt="latest property" class="img-responsive">
									</a>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="sec-heading center">
								<h2>Pricing</h2>
								<h3>Our Best <span class="theme-cl">Price</span></h3>
							</div>
						</div>
					</div>
					<!-- Row -->
					...
					<div class="row">
						...
						<!-- Single Package -->
						<div class="col-lg-4 col-md-4">
							<div class="Reveal-pricing-wrap">
								
								<div class="Reveal-pricing-header">
									<i class="lni-layers"></i>
									<h4 class="pr-title">Basic Package</h4>
									<span class="pr-subtitle">Starter</span>
								</div>
								<div class="Reveal-pricing-value">
									<h4 class="Reveal-pr-value">49</h4>
								</div>
								<div class="Reveal-pricing-body">
									<ul>
										<li>5+ Listings</li>
								...
								<div class="Reveal-pricing-bottom">
						...
						<!-- Single Package -->
						<div class="col-lg-4 col-md-4">
							<div class="Reveal-pricing-wrap recommended theme-bg">
								<div class="offclio"><i class="fas fa-star"></i></div>
								<div class="Reveal-pricing-header">
									<i class="lni-diamond"></i>
									<h4 class="pr-title">Platinum Package</h4>
									<span class="pr-subtitle">Business</span>
								</div>
								<div class="Reveal-pricing-value">
									<h4 class="Reveal-pr-value">149</h4>
								</div>
								<div class="Reveal-pricing-body">
									<ul>
										<li>5+ Listings</li>
						...
						<div class="col-lg-4 col-md-4">
							<div class="Reveal-pricing-wrap">
								...
								<div class="Reveal-pricing-header">
									...
									<span class="pr-subtitle">Platinum</span>
								</div>
								<div class="Reveal-pricing-value">
									<h4 class="Reveal-pr-value">199</h4>
								</div>
								<div class="Reveal-pricing-body">
									<ul>
										<li>5+ Listings</li>
